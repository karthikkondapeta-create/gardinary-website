  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center bg-botanical-fade">
      ...
      <div className="container-px relative z-10 grid md:grid-cols-2 gap-12 items-center w-full">
        <div>
          ...
          <motion.h1
            ...
            className="font-display text-6xl sm:text-7xl lg:text-8xl leading-[0.9] tracking-wide mb-6"
          >
            WEAR YOUR
            <br />
          ...
          <motion.p
            ...
            className="text-bone/70 max-w-md mb-8 text-base md:text-lg"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 text-bone/50 text-xs tracking-[0.3em] uppercase"
      >
        Scroll
      </motion.div>
    </section>
